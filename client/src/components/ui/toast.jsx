...
function Toasts(
  ...
  return (
    <Toast.Portal data-slot="toast-portal" {...portalProps}>
      <Toast.Viewport
        className={cn(
          "fixed z-60 mx-auto flex w-[calc(100%-var(--toast-inset)*2)] max-w-90 [--toast-inset:calc(4 * 0.25rem)] sm:[--toast-inset:calc(8 * 0.25rem)]",
          ...
          return (
            <Toast.Root
              ...
              className={cn(
                ...
                "[--toast-calc-height:var(--toast-frontmost-height,var(--toast-height))] [--toast-gap:calc(3 * 0.25rem)] [--toast-peek:calc(3 * 0.25rem)] [--toast-scale:calc(max(0,1-(var(--toast-index)*.1)))] [--toast-shrink:calc(1-var(--toast-scale))]",
      ...
      <Toast.Viewport className="outline-none" data-slot="toast-viewport-anchored">
        {toasts.map((toast) => {
          ...
          return (
            <Toast.Positioner
              key={toast.id}
              className="z-60 max-w-[min(calc(64 * 0.25rem),var(--available-width))]"
