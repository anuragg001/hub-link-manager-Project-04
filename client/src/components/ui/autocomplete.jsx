    ...
    <AutocompletePrimitive.InputGroup
      ...
      <AutocompletePrimitive.Input
        className={cn(startAddon &&
          "data-[size=sm]:*:data-[slot=autocomplete-input]:ps-[calc(calc(7.5 * 0.25rem)-1px)] *:data-[slot=autocomplete-input]:ps-[calc(calc(8.5 * 0.25rem)-1px)] sm:data-[size=sm]:*:data-[slot=autocomplete-input]:ps-[calc(calc(7 * 0.25rem)-1px)] sm:*:data-[slot=autocomplete-input]:ps-[calc(calc(8 * 0.25rem)-1px)]", sizeValue === "sm"
