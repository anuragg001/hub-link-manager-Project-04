...
export function Calendar(
  ...
  const defaultClassNames = {
    ...
    dropdown_root:
      "relative has-focus:border-ring has-focus:ring-ring/50 has-focus:ring-[3px] border border-input shadow-xs/5 rounded-lg px-[calc(calc(3 * 0.25rem)-1px)] h-9 sm:h-8 [&_svg:not([class*='opacity-'])]:opacity-80 [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:-me-1",
    dropdowns:
  ...
  const dayPickerProps = {
    className: cn(
      "w-fit [--cell-size:calc(10 * 0.25rem)] sm:[--cell-size:calc(9 * 0.25rem)]",
      className
    ),
