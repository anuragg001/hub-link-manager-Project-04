...
export function Input(
  ...
  const inputClassName = cn(
    "h-8.5 w-full min-w-0 rounded-[inherit] px-[calc(calc(3 * 0.25rem)-1px)] text-foreground leading-8.5 outline-none [transition:background-color_5000000s_ease-in-out_0s] placeholder:text-muted-foreground/72 sm:h-7.5 sm:leading-7.5 autofill:[-webkit-text-fill-color:var(--foreground)]",
    size === "sm" &&
      "h-7.5 px-[calc(calc(2.5 * 0.25rem)-1px)] leading-7.5 sm:h-6.5 sm:leading-6.5",
