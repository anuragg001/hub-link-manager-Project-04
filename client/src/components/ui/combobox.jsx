  ...
  return (
    <ComboboxPrimitive.InputGroup
      ...
      {startAddon && (
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-y-0 start-px z-10 flex items-center ps-[calc(calc(3 * 0.25rem)-1px)] opacity-80 has-[+[data-size=sm]]:ps-[calc(calc(2.5 * 0.25rem)-1px)] [&_svg:not([class*='size-'])]:size-4.5 sm:[&_svg:not([class*='size-'])]:size-4 [&_svg]:-mx-0.5"
      ...
      <ComboboxPrimitive.Input
        className={cn(startAddon &&
          "data-[size=sm]:*:data-[slot=combobox-input]:ps-[calc(calc(7.5 * 0.25rem)-1px)] *:data-[slot=combobox-input]:ps-[calc(calc(8.5 * 0.25rem)-1px)] sm:data-[size=sm]:*:data-[slot=combobox-input]:ps-[calc(calc(7 * 0.25rem)-1px)] sm:*:data-[slot=combobox-input]:ps-[calc(calc(8 * 0.25rem)-1px)]", sizeValue === "sm"
