    ...
    <span
      ...
      <FieldPrimitive.Control
        ...
        render={(defaultProps) => (
          <textarea
            className={cn(
              "field-sizing-content min-h-17.5 w-full rounded-[inherit] px-[calc(calc(3 * 0.25rem)-1px)] py-[calc(calc(1.5 * 0.25rem)-1px)] text-foreground outline-none placeholder:text-muted-foreground/72 max-sm:min-h-20.5",
              size === "sm" &&
                "min-h-16.5 px-[calc(calc(2.5 * 0.25rem)-1px)] py-[calc(calc(1 * 0.25rem)-1px)] max-sm:min-h-19.5",
              size === "lg" &&
                "min-h-18.5 py-[calc(calc(2 * 0.25rem)-1px)] max-sm:min-h-21.5"
            )}
            data-slot="textarea"
