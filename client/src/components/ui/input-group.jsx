...
const inputGroupAddonVariants = cva(
  "flex h-auto cursor-text select-none items-center justify-center gap-2 [&>kbd]:rounded-[calc(var(--radius)-5px)] in-[[data-slot=input-group]:has([data-slot=input-control],[data-slot=textarea-control])]:[&_svg:not([class*='size-'])]:size-4.5 sm:in-[[data-slot=input-group]:has([data-slot=input-control],[data-slot=textarea-control])]:[&_svg:not([class*='size-'])]:size-4 [&_svg]:-mx-0.5 not-has-[button]:**:[svg:not([class*='opacity-'])]:opacity-80",
  {
    ...
    variants: {
      align: {
        "block-end":
          "order-last w-full justify-start px-[calc(calc(3 * 0.25rem)-1px)] pb-[calc(calc(3 * 0.25rem)-1px)] [.border-t]:pt-[calc(calc(3 * 0.25rem)-1px)] [[data-size=sm]+&]:px-[calc(calc(2.5 * 0.25rem)-1px)]",
        "block-start":
          "order-first w-full justify-start px-[calc(calc(3 * 0.25rem)-1px)] pt-[calc(calc(3 * 0.25rem)-1px)] [.border-b]:pb-[calc(calc(3 * 0.25rem)-1px)] [[data-size=sm]+&]:px-[calc(calc(2.5 * 0.25rem)-1px)]",
        "inline-end":
          "order-last pe-[calc(calc(3 * 0.25rem)-1px)] has-[>:last-child[data-slot=badge]]:-me-1.5 has-[>button]:-me-2 has-[>kbd:last-child]:me-[-0.35rem] [[data-size=sm]+&]:pe-[calc(calc(2.5 * 0.25rem)-1px)]",
        "inline-start":
          "order-first ps-[calc(calc(3 * 0.25rem)-1px)] has-[>:last-child[data-slot=badge]]:-ms-1.5 has-[>button]:-ms-2 has-[>kbd:last-child]:ms-[-0.35rem] [[data-size=sm]+&]:ps-[calc(calc(2.5 * 0.25rem)-1px)]",
      },
    },
  }
);
