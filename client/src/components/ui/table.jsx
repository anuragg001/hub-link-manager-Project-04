...
export function TableCell(
  ...
  return (
    <td
      className={cn(
        "whitespace-nowrap bg-clip-padding p-2.5 in-data-[slot=table-footer]:py-3.5 align-middle leading-none in-data-[variant=card]:first:ps-[calc(calc(2.5 * 0.25rem)-1px)] in-data-[variant=card]:last:pe-[calc(calc(2.5 * 0.25rem)-1px)] has-[[role=checkbox]]:w-px last:has-[[role=checkbox]]:ps-0 first:has-[[role=checkbox]]:pe-0",
        className
      )}
